...
require 'puppet/util/network_device/transport_ios/sshios'

describe Puppet::Util::NetworkDevice::Transport_ios::Sshios, :if => Puppet.features.ssh? do

  before(:each) do
    @transport = Puppet::Util::NetworkDevice::Transport_ios::Sshios.new()
  end
